...
export function AppLayout({ children }: { children: React.ReactNode }) {
  return (
    <AppShell header={{ height: 56 }} navbar={{ width: 220, breakpoint: "sm" }} padding="md">
      <AppShell.Header><Group h="100%" px="md" gap="sm"><img src="/logo.png" alt="MDC" height={32} style={{ height: 32, width: "auto" }} /><Title order={4} c="brand.7">MDC Management</Title></Group></AppShell.Header>
